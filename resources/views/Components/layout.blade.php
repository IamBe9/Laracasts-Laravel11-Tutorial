...
<body class="h-full">
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                    ...
                    <x-nav-link href="/jobs" :active="request()->is('jobs')">Job List</x-nav-link>
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            ...
            <div class="ml-3">
                <div class="text-base/5 font-medium text-white">Danil Hrubskyi</div>
                <div class="text-sm font-medium text-gray-400">danilgrubskii@gmail.com</div>
            </div>
